...
class DashboardPortfolioCell: UICollectionViewCell {
    ...
    fileprivate func add_graph_spacer(portfolio_graph: Graph) {
        ...
        spacer.backgroundColor = UIColor.Theme_color1
    ...
    fileprivate func add_graph_view(animate: Bool) {
        ...
        if let portfolio_graph_view = portfolio_graph {
            ...
            portfolio_graph_view.render_graph(background_clr: UIColor.Theme_color2, lineWidth: 4.0)
    ...
    fileprivate func add_portfolio_total() {
        portfolio_ttl_lbl.style_portfolio_performance_label(font_size: 45, font_color: UIColor.Theme_color3, autolayout: false)
        portfolio_ttl_lbl.text = "$\(self.portfolio_total ?? 0.01)"
        portfolio_ttl_lbl.backgroundColor = UIColor.Theme_color2
